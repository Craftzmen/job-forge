...
import { jobApi, ExperienceLevel } from '@/lib/api';
...
export default function NewJobPage() {
    ...
    async function onSubmit(values: JobFormData) {
        ...
        try {
            ...
            setError(err.response?.data?.detail || err.response?.data?.title?.[0] || 'Failed to create job');
        } finally {
            setLoading(false);
        }
    }
            ...
            <div className="min-h-screen bg-background">
                ...
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground mt-1">Fill in the details to post a new job listing.</p>
                    </div>
