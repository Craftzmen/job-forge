...
import { resumeApi, Resume, aiApi } from '@/lib/api';
...
export default function EditResumePage() {
    ...
    async function onSubmit(values: ResumeFormData) {
        ...
        try {
            ...
            setError(err.response?.data?.detail || err.response?.data?.title?.[0] || 'Failed to update resume');
            ...
            <div className="p-6 md:p-8 max-w-5xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    <div>
                        ...
                        <p className="text-muted-foreground">Keep your professional profile up to date.</p>
                    </div>
                            ...
                            <div className="lg:col-span-2 space-y-8">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {experienceFields.length === 0 ? (
                                        <Card className="shadow-none border-dashed py-8 border-border/80">
                                            <CardContent className="flex flex-col items-center justify-center text-center opacity-60">
                                                <Briefcase className="w-12 h-12 mb-3 text-muted-foreground" />
                                                <p className="font-medium">No experience added yet</p>
                                                <p className="text-sm text-muted-foreground">Click the button above to add your first work history item.</p>
                                            </CardContent>
                                        </Card>
                                    ) : (
                                        <div className="space-y-4">
                                ...
                                <div className="space-y-4">
                                    ...
                                    {educationFields.length === 0 ? (
                                        <Card className="shadow-none border-dashed py-8 border-border/80">
                                            <CardContent className="flex flex-col items-center justify-center text-center opacity-60">
                                                <GraduationCap className="w-12 h-12 mb-3 text-muted-foreground" />
                                    ...
                                    <CardContent className="p-4 flex items-start gap-3">
                                        ...
                                        <div className="text-xs space-y-1">
                                            ...
                                            <p className="text-muted-foreground leading-relaxed">
                                                Active resumes are prioritized by our AI matching engine. Make sure your skills section is as detailed as possible to find better matches.
                                            </p>
                                        </div>
                                    </CardContent>
                                </Card>
